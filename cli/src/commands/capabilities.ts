...
export const CAPABILITIES: readonly Capability[] = [
  ...
  { command: 'product', description: '产品/客户/外部用户管理', phase: '4', status: 'available' },
  { command: 'ticket', description: '工单管理（CRUD+流转+元数据）', phase: '4', status: 'available' },
  { command: 'requirement', description: '需求管理（CRUD+流转+元数据）', phase: '4', status: 'available' },
  { command: 'test-library', description: '测试库管理', phase: '4', status: 'available' },
