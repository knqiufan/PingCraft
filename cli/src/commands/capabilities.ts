...
export const CAPABILITIES: readonly Capability[] = [
  ...
  { command: 'kanban', description: '看板管理', phase: '2', status: 'planned' },
  { command: 'waterfall', description: '瀑布管理', phase: '2', status: 'planned' },
  { command: 'global', description: '全局组织与通用资源', phase: '2', status: 'planned' },
  { command: 'wiki', description: '知识库 Wiki', phase: '3', status: 'planned' },
  { command: 'mcp', description: 'MCP Server 模式', phase: '3', status: 'planned' },
  { command: 'pingcraft', description: 'PingCraft 业务（需求分析/导入/编排）', phase: '3', status: 'planned' },
