...
> ✅ **v1.0.0**（Phase 0–5 全部完成）：鉴权、项目/工作项、Scrum/发布/看板/瀑布、全局资源、Wiki、MCP Server、PingCraft 业务、产品管理、测试管理、DevOps（scm/build/delivery）全部可用。CLI / MCP / 库三模式交付。完整计划见仓库根 `docs/cli/`，变更见 `CHANGELOG.md`。
